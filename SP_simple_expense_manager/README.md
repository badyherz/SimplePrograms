...
The program folder can be found at your local documents folder under your user.
...
Also DO NOT delete the commas behind the translation or else all translation will break.
