...
If your encounter any problems, open an issue and I'll try to have a look at it.
...
This let's you track tv series. Add, remove episodes. Has a progress bar. An archive to clean up a bit. Import and export functions of save files for your data. And it automatically saves when you close the program.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━

**Simulated Mouse Button Holding**

Simulates key presses for the mouse with custom activation key and hold and toggle option. Works most of the times, but sometimes it breaks (no idea why, could not be bothered). I used it to afk farm a block farm in Minecraft.
